...
aws dynamodb create-table   --table-name $DDB_TABLE \
                            ...
                            --region $REGION \
#--global-secondary-indexes IndexName=ThePlugUsernames,KeySchema={AttributeName=username,KeyType=HASH},Projection={ProjectionType=ALL},ProvisionedThroughput={ReadCapacityUnits=5,WriteCapacityUnits=5}
